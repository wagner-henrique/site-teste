        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CTAButton
                id="mobile-apps-hero-develop"
                type="primary"
                action="modal"
                target="contact"
                section="mobile-apps-hero"
                variant="gradient"
                size="lg"
              >
                Desenvolver Meu App
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {appTypes.map((app, index) => (
              ...
              >
                ...
                <CTAButton
                  id={`mobile-app-type-${index}`}
                  type="primary"
                  action="modal"
                  target="contact"
                  section="mobile-apps-types"
                  variant={app.popular ? "gradient" : "outline"}
                  fullWidth
                >
                  Solicitar Orçamento
                </CTAButton>

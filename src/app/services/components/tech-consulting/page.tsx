        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CTAButton
                id="tech-consulting-hero-schedule"
                type="primary"
                action="modal"
                target="contact"
                section="tech-consulting-hero"
                variant="gradient"
                size="lg"
              >
                Agendar Consultoria
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <CTAButton
                  id={`tech-consulting-plan-${index}`}
                  type="primary"
                  action="modal"
                  target="contact"
                  section="tech-consulting-plans"
                  variant="gradient"
                  fullWidth
                >
                  Escolher Plano
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CTAButton
                id="tech-consulting-cta-free"
                type="primary"
                action="modal"
                target="contact"
                section="tech-consulting-cta"
                variant="outline"
                size="lg"
              ...
              <CTAButton
                id="tech-consulting-cta-specialist"
                type="secondary"
                action="modal"
                target="contact"
                section="tech-consulting-cta"

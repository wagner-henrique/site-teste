...
export default function TechnicalSupportPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CTAButton
                id="tech-support-hero-contact"
                type="primary"
                action="modal"
                target="contact"
                section="tech-support-hero"
                variant="gradient"
                size="lg"
              >
                Falar com Suporte
      ...
      {/* Plans Section */}
      <section id="plans" className="py-20 bg-neutral-100 dark:bg-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <CTAButton
                  id={`tech-support-plan-${index}`}
                  type="primary"
                  action="modal"
                  target="contact"
                  section="tech-support-plans"
                  variant="gradient"
                  fullWidth
                >
                  Escolher Plano
